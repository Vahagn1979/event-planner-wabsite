...
const EventDetailContent = async ({userId, eventId} : {userId: string, eventId: string}) => {
    ...
    <div className="flex flex-col gap-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <p>
            Share this with guests so they can RSVP without creting an account.
          </p>
          {inviteUrl  ? <div className="rounded-sm border border-border bg-surface p-3 text-sm">
                          {inviteUrl}
                        </div>
